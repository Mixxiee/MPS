          ...
          (function (global) {
            (function () {
              ...
              var u = function (t) {
                  ...
                  return (
                    e.push(t.nodeName),
                    "#text" !== t.nodeName && "#comment" !== t.nodeName && t.attributes && (t.attributes.class && e.push("".concat(t.nodeName, ".").concat(t.attributes.class.replace(/ /g, "."))), t.attributes.id && e.push("".concat(t.nodeName, "#").concat(t.attributes.id))),
                    e
                  );
                },
                p = function (t) {
                    ...
                    (t.prototype.findOuterDiff = function (t, e, s) {
                      ...
                      if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data)
                        return "#text" === t.nodeName
                          ? [new x().setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)]
                          : [new x().setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)];
                      for (n = t.attributes ? Object.keys(t.attributes).sort() : [], a = e.attributes ? Object.keys(e.attributes).sort() : [], o = n.length, l = 0; l < o; l++)
                        (i = n[l]),
                          -1 === (r = a.indexOf(i))
                            ? d.push(new x().setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i]))
                            : (a.splice(r, 1),
                      ...
                      for (o = a.length, l = 0; l < o; l++)
                        (i = a[l]), d.push(new x().setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]));
                      return d;
                    }),
                          ...
                          if (!0 === u[b])
                              ...
                              if ("#text" === e.childNodes[b].nodeName) {
                                if (l.data !== e.childNodes[b].data) {
                                  ...
                                  if (!d)
                                    return (
                                      m.push(
                                        new x().setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.oldValue, l.data).setValue(this.options._const.newValue, e.childNodes[b].data)
                                      ),
                                      m
                                    );
                                }
                              } else
                                m.push(new x().setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)), u.splice(b, 1), (f = Math.min(u.length, p.length)), (b -= 1);
                            ...
                            "#text" === (l = e.childNodes[b]).nodeName
                              ? (m.push(new x().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.value, l.data)),
                                ...
                                (f = Math.min(u.length, p.length)),
                                (_ -= 1))
                              : (m.push(new x().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(b)).setValue(this.options._const.element, g(l))), u.splice(b, 0, !0), (f = Math.min(u.length, p.length)), (_ -= 1));
                          else if (u[b] !== p[b]) {
                    ...
                    (t.prototype.findValueDiff = function (t, e, s) {
                      ...
                      return (
                        t.selected !== e.selected &&
                          i.push(new x().setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)),
                        (t.value || e.value) &&
                          t.value !== e.value &&
                          "OPTION" !== t.nodeName &&
                          i.push(
              ...
              const A = (t, e, s, { classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l }, { noColumnWidths: d, unhideHeader: c }) => ({
                  ...
                  childNodes: t
                    .map((t, h) => {
                      ...
                      return { nodeName: "TH", attributes: p, childNodes: (!a && !r.length) || c ? (u.sortable && o ? [{ nodeName: "BUTTON", attributes: { class: u.filter ? i.filter : i.sorter }, childNodes: m }] : m) : [{ nodeName: "#text", data: "" }] };
                    })
                    .filter((t) => t),
                }),
              ...
              const J = {
                  ...
                  labels: { placeholder: "Filter", searchTitle: "Search within table", perPage: "resultaten", pageTitle: "Page {page}", noRows: "Geen resultaten gevonden", noResults: "Er zijn geen resultaten die overeenkomen met uw zoekopdracht", info: "Toont {start} t/m {end} van de {rows} resultaten" },
                  template: (t, e) =>
                ...
                W = (t, e, s, i = {}) => ({
                  ...
                  childNodes: [{ nodeName: "BUTTON", attributes: { "data-page": String(t), class: s.classes.paginationListItemLink, "aria-label": s.labels.pageTitle.replace("{page}", String(t)) }, childNodes: [{ nodeName: "#text", data: e }] }],
                }),
                Q = (t, e, s, i, n) => {
                  let a = [];
                          ...
                          c.forEach((e) => {
                            ...
                            if (h) {
                              ...
                              if (s - e == 2) u.push(t[e]);
                                ...
                                const t = { nodeName: "LI", attributes: { class: `${a.paginationListItem} ${a.ellipsis} ${a.disabled}` }, childNodes: [{ nodeName: "BUTTON", attributes: { class: a.paginationListItemLink }, childNodes: [{ nodeName: "#text", data: o }] }] };
                                u.push(t);
                              }
                            }
                            u.push(e), (h = e);
              ...
              (exports.DataTable = class {
                ...
                _renderTable(t = {}) {
                  let e = P(
                    ...
                    this.data.headings,
                    (this.options.paging || this._searchQueries.length || this.columns._state.filters.length) && this._currentPage && this.pages.length && !t.noPaging ? this.pages[this._currentPage - 1] : this.data.data.map((t, e) => ({ row: t, index: e })),
                ...
                _renderPage(t = !1) {
                  ...
                  let e,
                    ...
                    n = 0;
                  if (
                    (this.totalPages && ((s = this._currentPage - 1), (i = s * this.options.perPage), (n = i + this.pages[s].length), (i += 1), (e = this._searchQueries.length ? this._searchData.length : this.data.data.length)), this._label && this.options.labels.info.length)
                  ) {
